...
## TL;DR
The machine is an analog computer that uses marbles to represent bits, and coilguns that shoots the marbles to other columns to carry digits when a bit overflows.  As a note, this project is not finished. I am still working on it actively, but am publishing this preliminarily as my submission for Hack Club: The Game.
  
  
## Demo Video (Shows the issue with imprecise positioning)
An issue I am repeatedly running into is having to constantly reposition parts not glued or screw down. I can not get the marble to shoot precisely into the curved part. However this video shows how the logic gates operate and how the machine is capable of charging a capacitor bank, then discharging it by itself. In the video I am performing 1+1 and the marble is unable to properly overflow to get to 2.
...
[![PDF Preview](schematics/screenshot.png)](schematics/githubshcematic.pdf)
...
<img width="4032" height="2268" alt="IMG_9264" src="https://github.com/user-attachments/assets/3ab1fcf2-c9a2-4b62-9f4b-055581a40499" />
...
<img width="4032" height="2268" alt="IMG_9391" src="https://github.com/user-attachments/assets/1ed8c127-1e47-496e-bbd6-f5e01c0bc5fa" />
...
There are 2 relays I will add: 1 that is responsible for triggering the disposable camera charger. That simply interrupts and connects the positive terminal of the buck converter connected to it, to turn it on and off.
The other relay is connected to an external power supply, connected to a resistor that limits current to approx 160mA then connected to the thyristors gate. That relay is responsible for triggering the thyristor. 

## This project is unfinished. This is where I got to, but I am unable to get the coilgun to shoot the marble as high as it should go. I am actively investigating how to fix that, but I suspect either overvolting the disposable camera charging is introducing an issue, and or by my capacitor bank is fried after accidental abuse, and I simply need to switch with fresh ones. 
This is not the end of this project, but I am publishing it in its unfinished state so I can qualify for Hack Club the Game. 
You haven't seen the end of this yet!
